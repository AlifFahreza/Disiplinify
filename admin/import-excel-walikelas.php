...
<head>
    ...
    <title>Import Data Wali Kelas</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-5">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Import Data Wali Kelas</h6>
                    </div>
                    <div class="card-body p-4">
                        <form action="action/action-dataWaliKelasExcel.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="excelFile">Pilih File Excel:</label>
                                <input type="file" class="form-control-file" name="excelFile" id="excelFile"
                                    accept=".xls, .xlsx" required>
                            </div>
                            <button type="submit" name="submit" class="btn btn-primary w-100">Import Data Wali Kelas
                                Menggunakan Excel (.xls, .xlsx)</button>
                        </form>
                    </div>
                </div>
